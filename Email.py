...
def Email():
    ...
    fromaddr = "do-not-reply@forgeahead.io" #EMAIL address of the sender
    toaddr = "si@forgeahead.io" #EMAIL address of the receiver
    ...
    # Authentication
    s.login(fromaddr, "y5qaMXG2VN86aW0u") #Password_of_the_sender
