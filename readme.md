...
\*The script assumes you are using Cisco devices with the `code`cisco_ios`code` device type. Modify the script accordingly if you are working with  different device types.
